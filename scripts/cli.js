...
const contractABI = require("../artifacts/contracts/Rainbowwallet.sol/Rainbowwallet.json").abi;

program
    .name("rainbowwallet-cli")
    .description("CLI tool for Rainbowwallet smart contract")
    .version("1.0.0");
